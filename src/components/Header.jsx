...
const Header = () => {
  return (
    <div className="bg-black text-white font-sans min-h-screen">
      ...
      <button className="w-50 h-9 bg-white text-red-700 ml-28 mt-10 justify-center md:ml-150 ">
        Whatsapp us now
      </button>
      <div className="flex text-xs gap-12 p-3 mt-4 md:justify-between md:p-10 md:mt-5">
        <h6>BLACAPLE</h6>
